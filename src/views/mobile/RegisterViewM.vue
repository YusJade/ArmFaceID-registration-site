<template>
  <el-container class="container">
    <el-header>
      <div class="header">
        ...
        <div class="right-container">
          <el-button text style="font-size: small; width: 2rem;"
    ...
    <el-main>
      <div class="form-card ">
        ...
        <el-form ref="ruleFormRef" style="max-width: 300px; margin-top: 30px;"
      ...
      <div v-if="imageBase64" class="image-preview">
        <el-image style="width: 100%; height: 100%;" :src="imageBase64" alt="上传的图片"
                  fit="contain">
        </el-image>
      </div>
    </el-main>
  ...
  <el-drawer direction="btt" size="90%" v-model="drawerAbout" title="关于"
             :with-header="true">
    <ContributorCanvas></ContributorCanvas>
  </el-drawer>
  <el-drawer direction="ttb" size="95%" v-model="drawerChat" title="留言板"
             :with-header="false">
...
import { defineComponent, ref, reactive, type Ref, onMounted, onUnmounted } from 'vue'
...
//   "src/assets/chat_3.jpg",
//   "src/assets/chat_4.jpg",
//   "src/assets/chat_5.jpg",
//   "src/assets/chat_6.jpg",
//   "src/assets/chat_7.jpg",
// ])
...
const uploadChange = (file: UploadUserFile, fl: UploadUserFile[]) => {
